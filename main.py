...
with st.expander("About the App"):
     st.write("""
         This web application help you to otpimize the product sequence of your online order based on the route, priority and route plus priority method. This will help you to optimize the pick up time simultaneously reduce product damage.
     """)
